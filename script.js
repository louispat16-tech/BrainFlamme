...
const questionsData = [
    ...
    { question: "Quelle est la capitale de l'Australie ?", answers: ["Canberra", "Sydney", "Melbourne", "Perth"], correct: 0, info: "Canberra a été choisie comme capitale en 1908 comme compromis entre Sydney et Melbourne, qui se disputaient le titre !" },
    { question: "Qui a peint 'La Jeune Fille à la perle' ?", answers: ["Vermeer", "Rembrandt", "Da Vinci", "Van Gogh"], correct: 0, info: "Johannes Vermeer a peint ce chef-d'œuvre vers 1665. On l'appelle souvent 'La Joconde du Nord'." },
    { question: "Quel est l'élément chimique le plus abondant dans l'univers ?", answers: ["Hydrogène", "Oxygène", "Hélium", "Carbone"], correct: 0, info: "L'hydrogène constitue environ 75 % de la masse de l'univers et est le principal carburant des étoiles." },
    ...
    { question: "Quel est le plus grand océan du monde ?", answers: ["Océan Pacifique", "Océan Atlantique", "Océan Indien", "Océan Arctique"], correct: 0, info: "Le Pacifique est si grand qu'il pourrait contenir toutes les terres émergées de la planète !" },
    { question: "Combien d'os possède un adulte humain ?", answers: ["206", "180", "215", "250"], correct: 0, info: "À la naissance, un bébé a environ 270 os, mais beaucoup fusionnent entre eux durant la croissance." },
    { question: "Qui est l'auteur de '1984' ?", answers: ["George Orwell", "Aldous Huxley", "Ray Bradbury", "Albert Camus"], correct: 0, info: "George Orwell a écrit ce roman en 1948 (il a inversé les deux derniers chiffres pour le titre)." },
    { question: "Quelle planète est surnommée la 'Planète Rouge' ?", answers: ["Mars", "Vénus", "Jupiter", "Saturne"], correct: 0, info: "Sa couleur provient de l'oxyde de fer (la rouille) présent en grande quantité à sa surface." },
    { question: "Quelle est la monnaie du Japon ?", answers: ["Yen", "Won", "Yuan", "Ringgit"], correct: 0, info: "Le mot 'Yen' signifie littéralement 'objet rond' en japonais." },
    { question: "Qui a découvert la pénicilline ?", answers: ["Alexander Fleming", "Louis Pasteur", "Marie Curie", "Albert Einstein"], correct: 0, info: "Fleming l'a découverte par accident en 1928 après avoir laissé une boîte de Pétri sans surveillance !" },
    { question: "Quel est le fleuve le plus long du monde ?", answers: ["L'Amazone", "Le Nil", "Le Mississippi", "Le Yangtsé"], correct: 0, info: "L'Amazone détient le record du débit le plus élevé, mais le Nil reste le plus long (environ 6 650 km)." },
    ...
    { question: "Quel est le symbole chimique de l'Or ?", answers: ["Au", "Ag", "Fe", "Or"], correct: 0, info: "Le symbole 'Au' vient du mot latin 'Aurum', qui signifie 'aurore'." },
    ...
    { question: "Qui a écrit 'Les Misérables' ?", answers: ["Victor Hugo", "Émile Zola", "Balzac", "Flaubert"], correct: 0, info: "Victor Hugo a mis 17 ans pour terminer l'écriture de ce monument de la littérature française." },
    { question: "Quelle est la capitale du Canada ?", answers: ["Ottawa", "Toronto", "Montréal", "Vancouver"], correct: 0, info: "Ottawa a été choisie par la reine Victoria en 1857 car elle était située entre les zones anglophones et francophones." },
    { question: "En quelle année l'homme a-t-il marché sur la Lune pour la première fois ?", answers: ["1969", "1965", "1972", "1961"], correct: 0, info: "Neil Armstrong et Buzz Aldrin ont aluni le 20 juillet 1969 lors de la mission Apollo 11." },
    { question: "Quel est l'organe le plus lourd du corps humain ?", answers: ["Le foie", "Le cerveau", "Le cœur", "Les poumons"], correct: 0, info: "Le foie pèse environ 1,5 kg. (Note : La peau est techniquement plus lourde, mais c'est un tissu/système !)" },
    ...
    { question: "Quelle est la langue la plus parlée au monde (langue maternelle) ?", answers: ["Mandarin", "Anglais", "Espagnol", "Hindi"], correct: 0, info: "Plus de 900 millions de personnes ont le mandarin comme langue maternelle." },
    { question: "Qui était le dieu grec du commerce ?", answers: ["Hermès", "Apollon", "Arès", "Poséidon"], correct: 0, info: "Hermès était aussi le messager des dieux et le protecteur des voyageurs (et des voleurs !)." },
    { question: "Quelle ville est surnommée 'La Grosse Pomme' ?", answers: ["New York", "Los Angeles", "Chicago", "Miami"], correct: 0, info: "Ce surnom est devenu populaire dans les années 1920 grâce à une chronique sur les courses hippiques." },
    { question: "Quel est le plus grand désert du monde ?", answers: ["Antarctique", "Sahara", "Gobi", "Désert d'Arabie"], correct: 0, info: "Un désert est défini par ses faibles précipitations. L'Antarctique est donc techniquement un désert froid !" },
    { question: "Quelle est la vitesse de la lumière (environ) ?", answers: ["300 000 km/s", "150 000 km/s", "1 000 000 km/s", "30 000 km/s"], correct: 0, info: "À cette vitesse, on pourrait faire sept fois et demie le tour de la Terre en une seule seconde." },
    { question: "Qui a sculpté le 'Penseur' ?", answers: ["Auguste Rodin", "Michel-Ange", "Bernini", "Donatello"], correct: 0, info: "À l'origine, cette statue devait faire partie d'une porte monumentale appelée 'La Porte de l'Enfer'." },
    { question: "Dans quelle ville se trouve le siège de l'ONU ?", answers: ["New York", "Genève", "Paris", "Bruxelles"], correct: 0, info: "Bien qu'à New York, le terrain est considéré comme territoire international." },
    { question: "Quel animal est le plus rapide au monde ?", answers: ["Faucon pèlerin", "Guépard", "Espadon", "Autruche"], correct: 0, info: "En piqué, le faucon pèlerin peut atteindre une vitesse dépassant les 320 km/h !" },
    { question: "Quel est l'indice de pH d'une solution neutre ?", answers: ["7", "0", "14", "5"], correct: 0, info: "L'eau pure a un pH de 7. En dessous c'est acide, au-dessus c'est basique." },
    { question: "Quelle est la capitale de la Turquie ?", answers: ["Ankara", "Istanbul", "Izmir", "Antalya"], correct: 0, info: "Istanbul est la plus grande ville, mais Ankara est la capitale depuis la création de la République en 1923." },
    { question: "Qui a peint 'Guernica' ?", answers: ["Pablo Picasso", "Salvador Dalí", "Joan Miró", "Frida Kahlo"], correct: 0, info: "Cette œuvre dénonce le bombardement de la ville de Guernica pendant la guerre d'Espagne en 1937." },
    { question: "Quel est le plus petit pays du monde ?", answers: ["Vatican", "Monaco", "Nauru", "Saint-Marin"], correct: 0, info: "Le Vatican s'étend sur seulement 0,44 km² à l'intérieur de la ville de Rome." },
    ...
    { question: "Quel est le métal le plus utilisé au monde ?", answers: ["Fer", "Aluminium", "Cuivre", "Plomb"], correct: 0, info: "Le fer (et ses alliages comme l'acier) représente 95 % du tonnage mondial des métaux produits." },
    ...
    { question: "Qui a inventé le téléphone ?", answers: ["Alexander Graham Bell", "Thomas Edison", "Nikola Tesla", "Guglielmo Marconi"], correct: 0, info: "Bien que Bell ait déposé le brevet, l'Italien Antonio Meucci est aujourd'hui reconnu comme le véritable inventeur." },
    { question: "Quel est l'oiseau qui ne peut pas voler ?", answers: ["L'Autruche", "L'Aigle", "Le Moineau", "Le Corbeau"], correct: 0, info: "L'autruche compense son incapacité à voler par une vitesse de course pouvant atteindre 70 km/h." },
    { question: "Quelle est la capitale de l'Islande ?", answers: ["Reykjavik", "Oslo", "Helsinki", "Copenhague"], correct: 0, info: "C'est la capitale la plus septentrionale (située au nord) du monde." },
    { question: "Qui a écrit 'Le Petit Prince' ?", answers: ["Antoine de Saint-Exupéry", "Jean Giono", "Marcel Pagnol", "Colette"], correct: 0, info: "C'est l'un des livres les plus traduits au monde après la Bible !" },
    { question: "Quel est le plus grand mammifère terrestre ?", answers: ["Éléphant d'Afrique", "Rhinocéros", "Girafe", "Hippopotame"], correct: 0, info: "Un mâle peut peser jusqu'à 6 tonnes et mesurer 4 mètres au garrot." },
    ...
    { question: "Quelle est la capitale du Portugal ?", answers: ["Lisbonne", "Porto", "Madrid", "Barcelone"], correct: 0, info: "Lisbonne est l'une des plus vieilles villes du monde, plus ancienne que Rome ou Londres !" },
