...
const questionsData = [
    ...
    { question: "Quelle est la voiture de série à moteur thermique la plus rapide du monde en vitesse de pointe ?", answers: ["Bugatti Chiron Super Sport 300+", "Ferrari LaFerrari", "Porsche 911 GT3", "Lamborghini Aventador"], correct: 0, info: "Elle a franchi la barre mythique des 490 km/h (304 mph) sur piste d'essai." },
    { question: "Quel groupe automobile regroupe notamment les marques Peugeot, Citroën, Fiat et Jeep ?", answers: ["Renault-Nissan", "Stellantis", "Volkswagen Group", "General Motors"], correct: 1, info: "Stellantis est né en 2021 de la fusion entre le groupe PSA et Fiat Chrysler Automobiles." },
    ...
    { question: "Dans quel d'animation Pixar croise-t-on le petit robot nettoyeur Wall-E ?", answers: ["Robots", "Wall-E", "Les Indestructibles", "Là-haut"], correct: 1, info: "Le film traite d'un petit robot resté seul sur une Terre abandonnée." },
    ...
    { question: "Quel d'animation Disney met en avant les sœurs Anna et Elsa ?", answers: ["Raiponce", "La Reine des Neiges", "Vaiana", "Encanto"], correct: 1, info: "La Reine des Neiges est sorti au cinéma en 2013." },
