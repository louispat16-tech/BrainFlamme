...
const questionsData = [
    ...
    { question: "Qui a peint 'La Jeune Fille à la perle' ?", answers: ["Vermeer", "Rembrandt", "Da Vinci", "Van Gogh"], correct: 0 },
    { question: "Quel est l'élément chimique le plus abondant dans l'univers ?", answers: ["Hydrogène", "Oxygène", "Hélium", "Carbone"], correct: 0 },
    { question: "En quelle année a eu lieu la chute du mur de Berlin ?", answers: ["1989", "1991", "1987", "1985"], correct: 0 },
    { question: "Quel pays a remporté la Coupe du Monde de football en 2010 ?", answers: ["Espagne", "Pays-Bas", "Allemagne", "Brésil"], correct: 0 },
    { question: "Quel est le plus grand océan du monde ?", answers: ["Océan Pacifique", "Océan Atlantique", "Océan Indien", "Océan Arctique"], correct: 0 },
    { question: "Combien d'os possède un adulte humain ?", answers: ["206", "180", "215", "250"], correct: 0 },
    { question: "Qui est l'auteur de '1984' ?", answers: ["George Orwell", "Aldous Huxley", "Ray Bradbury", "Albert Camus"], correct: 0 },
    { question: "Quelle planète est surnommée la 'Planète Rouge' ?", answers: ["Mars", "Vénus", "Jupiter", "Saturne"], correct: 0 },
    { question: "Quelle est la monnaie du Japon ?", answers: ["Yen", "Won", "Yuan", "Ringgit"], correct: 0 },
    { question: "Qui a découvert la pénicilline ?", answers: ["Alexander Fleming", "Louis Pasteur", "Marie Curie", "Albert Einstein"], correct: 0 },
    { question: "Quel est le fleuve le plus long du monde ?", answers: ["L'Amazone", "Le Nil", "Le Mississippi", "Le Yangtsé"], correct: 0 },
    { question: "Dans quel pays se trouve la ville de Tombouctou ?", answers: ["Mali", "Sénégal", "Niger", "Algérie"], correct: 0 },
    { question: "Quel est le symbole chimique de l'Or ?", answers: ["Au", "Ag", "Fe", "Or"], correct: 0 },
    { question: "Quel est le film le plus récompensé aux Oscars (11 statuettes) ?", a: ["Titanic", "Avatar", "Le Parrain", "La Liste de Schindler"], correct: 0 },
    { question: "Qui a écrit 'Les Misérables' ?", answers: ["Victor Hugo", "Émile Zola", "Balzac", "Flaubert"], correct: 0 },
    { question: "Quelle est la capitale du Canada ?", answers: ["Ottawa", "Toronto", "Montréal", "Vancouver"], correct: 0 },
    { question: "En quelle année l'homme a-t-il marché sur la Lune pour la première fois ?", answers: ["1969", "1965", "1972", "1961"], correct: 0 },
    { question: "Quel est l'organe le plus lourd du corps humain ?", answers: ["Le foie", "Le cerveau", "Le cœur", "Les poumons"], correct: 0 },
    { question: "Quel gaz les plantes absorbent-elles pour la photosynthèse ?", answers: ["Dioxyde de carbone", "Oxygène", "Azote", "Méthane"], correct: 0 },
    { question: "Quelle est la langue la plus parlée au monde (langue maternelle) ?", answers: ["Mandarin", "Anglais", "Espagnol", "Hindi"], correct: 0 },
    { question: "Qui était le dieu grec du commerce ?", answers: ["Hermès", "Apollon", "Arès", "Poséidon"], correct: 0 },
    { question: "Quelle ville est surnommée 'La Grosse Pomme' ?", answers: ["New York", "Los Angeles", "Chicago", "Miami"], correct: 0 },
    { question: "Quel est le plus grand désert du monde ?", answers: ["Antarctique", "Sahara", "Gobi", "Désert d'Arabie"], correct: 0 },
    { question: "Quelle est la vitesse de la lumière (environ) ?", answers: ["300 000 km/s", "150 000 km/s", "1 000 000 km/s", "30 000 km/s"], correct: 0 },
    { question: "Qui a sculpté le 'Penseur' ?", answers: ["Auguste Rodin", "Michel-Ange", "Bernini", "Donatello"], correct: 0 },
    { question: "Dans quelle ville se trouve le siège de l'ONU ?", answers: ["New York", "Genève", "Paris", "Bruxelles"], correct: 0 },
    { question: "Quel animal est le plus rapide au monde ?", answers: ["Faucon pèlerin", "Guépard", "Espadon", "Autruche"], correct: 0 },
    { question: "Quel est l'indice de pH d'une solution neutre ?", answers: ["7", "0", "14", "5"], correct: 0 },
    { question: "Quelle est la capitale de la Turquie ?", answers: ["Ankara", "Istanbul", "Izmir", "Antalya"], correct: 0 },
    { question: "Qui a peint 'Guernica' ?", answers: ["Pablo Picasso", "Salvador Dalí", "Joan Miró", "Frida Kahlo"], correct: 0 },
    { question: "Quel est le plus petit pays du monde ?", answers: ["Vatican", "Monaco", "Nauru", "Saint-Marin"], correct: 0 },
    { question: "En quel siècle a vécu Jeanne d'Arc ?", answers: ["15ème", "13ème", "17ème", "14ème"], correct: 0 },
    { question: "Quel pays possède le plus de pyramides ?", answers: ["Soudan", "Égypte", "Mexique", "Pérou"], correct: 0 },
    { question: "Quel est le métal le plus utilisé au monde ?", answers: ["Fer", "Aluminium", "Cuivre", "Plomb"], correct: 0 },
    { question: "Quelle est la distance Terre-Soleil (environ) ?", answers: ["150 millions km", "50 millions km", "300 millions km", "10 millions km"], correct: 0 },
    { question: "Qui a inventé le téléphone ?", answers: ["Alexander Graham Bell", "Thomas Edison", "Nikola Tesla", "Guglielmo Marconi"], correct: 0 },
    { question: "Quel est l'oiseau qui ne peut pas voler ?", answers: ["L'Autruche", "L'Aigle", "Le Moineau", "Le Corbeau"], correct: 0 },
    { question: "Quelle est la capitale de l'Islande ?", answesr: ["Reykjavik", "Oslo", "Helsinki", "Copenhague"], correct: 0 },
    { question: "Qui a écrit 'Le Petit Prince' ?", answers: ["Antoine de Saint-Exupéry", "Jean Giono", "Marcel Pagnol", "Colette"], correct: 0 },
    { question: "Quel est le plus grand mammifère terrestre ?", answers: ["Éléphant d'Afrique", "Rhinocéros", "Girafe", "Hippopotame"], correct: 0 },
    { question: "Quel pays a offert la Statue de la Liberté aux États-Unis ?", answers: ["France", "Royaume-Uni", "Allemagne", "Italie"], correct: 0 },
    { question: "Quelle est la capitale du Portugal ?", answers: ["Lisbonne", "Porto", "Madrid", "Barcelone"], correct: 0 },
    { question: "Qui est le dieu romain de la guerre ?", answers: ["Mars", "Jupiter", "Neptune", "Vulcain"], correct: 0 },
    { question: "Dans quelle galaxie se trouve la Terre ?", answers: ["La Voie Lactée", "Andromède", "Sombrero", "Messier 87"], correct: 0 },
    { question: "Quel est le compositeur de 'La 5ème Symphonie' ?", answers: ["Beethoven", "Mozart", "Bach", "Chopin"], correct: 0 },
    { question: "Quel est l'ingrédient principal du houmous ?", answers: ["Pois chiche", "Lentilles", "Fèves", "Haricots blancs"], correct: 0 },
    { question: "Quelle est la capitale de la Corée du Sud ?", answers: ["Séoul", "Busan", "Pyongyang", "Tokyo"], correct: 0 },
    { question: "Quel est le point culminant de l'Afrique ?", answers: ["Kilimandjaro", "Mont Kenya", "Mont Toubkal", "Everest"], correct: 0 },
    { question: "Qui a créé le personnage de Sherlock Holmes ?", answers: ["Arthur Conan Doyle", "Agatha Christie", "Edgar Allan Poe", "Maurice Leblanc"], correct: 0 },
