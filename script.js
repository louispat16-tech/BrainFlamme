...
const questionsData = [
    ...
    { question: "Dans quel sport utilise-t-on les termes 'birdie', 'eagle' et 'bogey' ?", answers: ["Le Tennis", "Le Golf", "Le Badminton", "Le Polo"],     { question: "Quelle est la capitale du Japon ?", answers: ["Kyoto", "Osaka", "Tokyo", "Hiroshima"], correct: 2, info: "Le grand Tokyo est la zone urbaine la plus peuplée au monde avec plus de 37 millions d'habitants." },
